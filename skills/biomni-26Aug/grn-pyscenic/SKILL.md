...
name: "grn-pyscenic"
description: "Use to infer transcription-factor gene-regulatory networks and cell-level regulon activity from scRNA-seq data with pySCENIC."
...
- `scenic_analysis_report.pdf` - PDF report created with `pdf-report-generation`; packaged markdown/script output is a fallback if the dedicated reporting skill is unavailable
