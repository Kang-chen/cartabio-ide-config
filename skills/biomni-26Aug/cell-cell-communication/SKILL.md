...
description: "Use to infer and visualize ligand-receptor signaling and cell-cell communication networks from scRNA-seq data with CellChat v2."
...
- `analysis_report.pdf` — PDF report created with `pdf-report-generation`; packaged markdown/script output is a fallback if the dedicated reporting skill is unavailable
...
| **PDF report skipped** | Dedicated report generation unavailable or rendering failed | Markdown report still available; disclose the fallback |
