...
```bash
snpEff ann -dataDir /path/to/snpeff/data/ GRCh38.115 input.vcf
```
...
snpEff ann GRCh38.115 input.vcf | \
...
pip install pandas numpy cyvcf2 pysam matplotlib xlsxwriter openpyxl
```
