...
snpEff download -dataDir ~/.snpeff GRCh38.115
...
pip install pandas numpy matplotlib pysam cyvcf2 xlsxwriter openpyxl
...
java -Xmx8g -jar snpEff.jar ann GRCh38.115 input.vcf
```
...
```bash
# Update all packages
pip install --upgrade pandas numpy matplotlib pysam cyvcf2 xlsxwriter openpyxl
