...
def filter_by_consequence(df, impact=None, consequence_types=None, consequence_levels=None):
    """
    ...
    consequence_levels : list, optional
        Backward-compatible alias for impact levels.
    ...
    pd.DataFrame
        Filtered DataFrame
    """
    if impact is None and consequence_levels is not None:
        impact = consequence_levels
