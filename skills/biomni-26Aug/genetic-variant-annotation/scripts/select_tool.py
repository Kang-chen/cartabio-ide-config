...
def select_annotation_tool(organism, use_case, resources, annotation_priorities=None):
    """
    ...
    annotation_priorities : list, optional
    ...
    'snpeff'
    """
    if annotation_priorities is None:
...
def get_vep_recommended_config(use_case, annotation_priorities=None):
    """
...
def compare_tools(organism='human', use_case='clinical'):
    ...
    comparison = {
        'vep': {
            'pros': [
                'Comprehensive clinical annotations (ClinVar, HGMD)',
