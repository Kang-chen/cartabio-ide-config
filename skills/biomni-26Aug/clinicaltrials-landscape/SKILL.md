...
description: "Use to map the ClinicalTrials.gov trial landscape for a disease, mechanism, intervention, phase, status, or sponsor through API v2."
category: "literature"
visibility: "public"
...
- `landscape_overview.png/.svg` — 6-panel landscape figure
...
**Reports:**
- `landscape_report.pdf` — Analysis-ready PDF with 24 sections: executive summary, mechanism deep-dives, geographic landscape, study design, phase transition funnel, endpoint comparison, combination therapies, biosimilar assessment, whitespace analysis, and more
...
3. **Biomarker analysis** — Use `elastic-net-biomarker-panel` to identify response biomarkers from trial data
...
- `elastic-net-biomarker-panel` — Biomarker discovery from expression data
