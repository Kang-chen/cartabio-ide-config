...
description: "Use to infer differentiation or disease trajectories from scRNA-seq, including pseudotime, branch structure, RNA velocity, terminal states, and cell-fate probabilities."
...
**Reports:**
- `trajectory_analysis_report.pdf` — PDF report created with `pdf-report-generation`; packaged markdown/script output is a fallback if the dedicated reporting skill is unavailable
